...
public class RouterFilter implements Filter {
    ...
    private static final String[] AdminOnlyUrls = {
        "/deleteproduct", "/editproduct", "/loadproduct", "/newproduct"
    };
...
//        }
        ...
        if(a!=null){
            isAdmin = (a.getUsername().equalsIgnoreCase("ADMIN"));
        }
        ...
        } else if (!isAdmin && isLoginRequired()) {
    ...
    private boolean isLoginRequired() {
        ...
        for (String adminPermission : AdminOnlyUrls) {
            if (requestURL.contains(adminPermission)) {
                return true;
            }
        }
        return false;
